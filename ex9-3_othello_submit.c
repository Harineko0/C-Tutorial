...
#define ONE_BIT_MASK_MAX 0x8000000000000000
...
int scoreOfHalfRow(int index, uint player, uint opponent) {
    ...
    const int maxPattern = 0b11111111;
...
void printPassed(bool playerIsHuman) {
    printf("\033[4A   %s passed. \033[4B", playerIsHuman ? "YOU" : "COMPUTER");
}
