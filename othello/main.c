...
int test() {
    ...
    ull hull_and_0[size], hull_or_0[size],
    ...
    or(hull_and_0, size, hull_or_0_0, hull_or_0_1, NULL);
    and(hull_or_0, size, hull_or_0_0, hull_or_0_1, NULL);
    expectHULL("or_0", hull_and_0, hull_or_0_exp, size);
    expectHULL("and_0", hull_or_0, hull_and_0_exp, size);
